...
**Remark:** The internal functions `pdSpecEst:::E_coeff_inv()` and `pdSpecEst:::T_coeff_inv()` convert (real-valued) basis components to tangent space elements (Hermitian matrices) using an orthonormal basis of the tangent space as described in [@COvS17].
