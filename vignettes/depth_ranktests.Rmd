...
We can compare the most central HPD matrix above with the (approximate) empirical geometric mean of the observations obtained with `pdMean()`. The empirical geometric mean is known to maximize the data depth for observations from a *centrally symmetric* distribution (as in this example). For more details, see [@COvS17].
